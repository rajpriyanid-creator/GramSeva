...
export default function SchemeDetailScreen() {
  ...
  const downloadChecklist = async () => {
    ...
    try {
      const url = `${process.env.EXPO_PUBLIC_API_URL}/api/pdf/checklist/${id}`;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: scheme.name.slice(0, 30) }} />
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.benefitCard}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.benefitLabel}>What you get</Text>
...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 16, color: "#A8D5B5", marginBottom: 4 },
  ministry: { fontSize: 13, color: "#6B9E7A", marginBottom: 20 },
  benefitCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
  ...
  benefitLabel: { fontSize: 11, color: "#A8D5B5", textTransform: "uppercase" },
  benefitValue: { fontSize: 16, fontWeight: "700", color: "#81C784", marginTop: 2 },
  section: {
    marginBottom: 20,
    backgroundColor: "#1A5C42",
    borderRadius: 14,
  ...
  sectionValue: { fontSize: 15, color: "#FFFFFF", marginBottom: 8 },
  helplineRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  helplineText: { fontSize: 15, color: "#F5C518", fontWeight: "600" },
  docRow: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 6 },
  docText: { fontSize: 14, color: "#c8e6c9" },
  pdfButton: {
    flexDirection: "row",
    alignItems: "center",
